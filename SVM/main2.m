...
modelDef = fitcsvm(training_label_vector, training_instance_matrix, '-t 1 -g 0.07');
modelSMallerG = fitcsvm(training_label_vector, training_instance_matrix, '-t 1 -g 0.01');
modelHigherG = fitcsvm(training_label_vector, training_instance_matrix, '-t 1 -g 0.20');
modelEvenHigherG = fitcsvm(training_label_vector, training_instance_matrix, '-t 1 -g 0.50');
modelHighestG = fitcsvm(training_label_vector, training_instance_matrix, '-t 1 -g 0.91');
